<?php
	...
	$query = 'INSERT INTO personnel (firstName, lastName, jobTitle, email, phoneNumber, departmentID) VALUES("' . $firstName . '", "' . $lastName . '", "' 
	. $jobTitle . '", "' . $email . '", "' . $phoneNumber . '", ' . $departmentID . ')';
